...
# Data file paths
TRAIN_FILES="rl_datasets/train_10k.parquet" # Modify training data path
VALID_FILES="rl_datasets/valid.parquet" # Modify validation data path

# ============================ Model Configuration ============================
# Actor model path
ACTOR_MODEL_PATH=Qwen/Qwen2.5-3B-Instruct # Modify training model path
...
SEARCH_CACHE_PATH="search_cache/search_cache.json" # Modify

# ============================ Reward Model Configuration ==========================
# Reward model settings
REWARD_MANAGER="naive"              # Reward manager type
CUSTOM_REWARD_FUNCTION_PATH="verl/utils/reward_score/deep_research.py" # Modify reward function path
...
# ============================ Path Configuration ============================
# Save path
SAVE_PATH="output/${EXPERIMENT_NAME}" # Modify save path
...
# ============================ Start Training ============================
python3 -m recipe.arpo.main_arpo \
