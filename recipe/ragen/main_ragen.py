...
from recipe.ragen.trainer.agent_trainer import RayAgentTrainer
...
class TaskRunner:
    ...
    def run(self, config):
        ...
        if config.actor_rollout_ref.actor.strategy == 'fsdp':
            ...
            from recipe.ragen.workers.fsdp_workers import ActorRolloutRefWorker, CriticWorker
        ...
        if config.reward_model.enable:
            if config.reward_model.strategy == 'fsdp':
                from recipe.ragen.workers.fsdp_workers import RewardModelWorker
