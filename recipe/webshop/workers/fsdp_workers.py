...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == "hf":
            ...
            from recipe.webshop.workers.sharding_manager.fsdp_vllm import FSDPVLLMShardingManager
    ...
    def init_model(self):
        from recipe.webshop.workers.actor import DataParallelPPOActor
...
class CriticWorker(Worker):
    ...
    def init_model(self):
        ...
        from recipe.webshop.workers.critic import DataParallelPPOCritic
